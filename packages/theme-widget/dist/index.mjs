import { createContext, useMemo, useState, useEffect, useCallback, useContext, useRef } from 'react';
  ...
  return /* @__PURE__ */ jsxs(
    "button",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("span", { className: "theme-widget-option-text", children: [
          /* @__PURE__ */ jsx(
            "span",
            {
              className: cn(
          ...
          /* @__PURE__ */ jsx("span", { className: "theme-widget-option-desc", children: description })
        ] }),
        /* @__PURE__ */ jsx(
          "span",
          {
            ...
            children: active && /* @__PURE__ */ jsx("span", { className: "theme-widget-radio-dot" })
          }
        )
      ]
    }
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxs("div", { className: "theme-widget-panel-header", children: [
            /* @__PURE__ */ jsx("h2", { className: "theme-widget-panel-title", children: panelConfig.title }),
            /* @__PURE__ */ jsx(
              "button",
              {
                ref: closeRef,
                ...
                children: /* @__PURE__ */ jsx(X, { className: "theme-widget-close-icon", "aria-hidden": "true" })
              }
            )
          ] }),
          /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsx(
                  ThemeOption,
                  {
                    icon: /* @__PURE__ */ jsx(Monitor, { className: "theme-widget-icon" }),
                    label: "System",
                ...
                /* @__PURE__ */ jsx(
                  ThemeOption,
                  {
                    icon: /* @__PURE__ */ jsx(Sun, { className: "theme-widget-icon" }),
                    label: "Light",
                ...
                /* @__PURE__ */ jsx(
                  ThemeOption,
                  {
                    icon: /* @__PURE__ */ jsx(Moon, { className: "theme-widget-icon" }),
                    label: "Dark",
...
function ThemeLauncherInner() {
  ...
  const prefersReduced = typeof window !== "undefined" ? window.matchMedia("(prefers-reduced-motion: reduce)").matches : false;
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(AnimatePresence, { children: open && /* @__PURE__ */ jsx(ThemePanel, { onClose: handleClose }) }),
    /* @__PURE__ */ jsx(
      motion.button,
      {
        ref: triggerRef,
        ...
        children: /* @__PURE__ */ jsx(Icon, { className: "theme-widget-launcher-icon", "aria-hidden": "true" })
      }
    )
  ] });
}
...
export { ThemeLauncher, ThemeProvider, useTheme };
